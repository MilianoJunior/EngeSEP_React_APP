...
import {Center, Menu, Circle, View, HStack, ScrollView, Text, Container,Image,Flex, Icon, Heading,Input, VStack, Box, Checkbox, Divider, Link} from 'native-base';
...
export function Lista(props){
    ...
    Object.keys(props.state.history_data).map((item) => {
        console.log(item + " = " + props.state.history_data[item][0]);
      });
    return (
